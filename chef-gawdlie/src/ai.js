...
additional ingredients they didn't mention, but try not to 
include too many extra ingredients. Format your response in 
...
export async function getAnthropicRecipe(ingredientsArr) {
